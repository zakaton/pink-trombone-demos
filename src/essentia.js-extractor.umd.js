(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : ((global =
      ...
      (global.EssentiaExtractor = factory()));
})(this, function () {
  "use strict";
  ...
  var EssentiaExtractor = /** @class */ (function (_super) {
     ...
     */
    EssentiaExtractor.prototype.melSpectrumExtractor = function (
      audioFrame,
      sampleRate,
      asVector,
      config
     ...
     * @memberof EssentiaExtractor
     */
    EssentiaExtractor.prototype.hpcpExtractor = function (
      audioFrame,
      sampleRate,
      asVector,
      config
      ...
      var spectrumOut = this.Spectrum(windowOut.frame, _frameSize);
      var peaksOut = this.SpectralPeaks(
        spectrumOut.spectrum,
      ...
      var whiteningOut = this.SpectralWhitening(
        spectrumOut.spectrum,
