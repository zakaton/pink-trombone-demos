!(function (t) {
  ...
  function (t, e, i) {
        ...
        seed: {
          value: function (t) {
            ...
            for (var e = 0; e < Math.pow(2, 8); e++) {
              ...
              (this.perm[e] = this.perm[e + Math.pow(2, 8)] = n),
                (this.gradP[e] = this.gradP[e + Math.pow(2, 8)] =
                  this.grad3[n % this.grad3.length]);
            }
          },
        },
        simplex2: {
          value: function (t, e) {
            ...
            var d = this.gradP[n + this.perm[r]],
              ...
              v = 0.5 - Math.pow(a, 2) - Math.pow(o, 2),
              y = v < 0 ? 0 : Math.pow(v, 4) * d.dot2(a, o),
              x = 0.5 - Math.pow(u, 2) - Math.pow(c, 2),
              b = x < 0 ? 0 : Math.pow(x, 4) * m.dot2(u, c),
              w = 0.5 - Math.pow(f, 2) - Math.pow(p, 2);
            return 70 * (y + b + (w < 0 ? 0 : Math.pow(w, 4) * g.dot2(f, p)));
          },
        },
        simplex1: {
          value: function (t) {
        ...
        (i = [
          {
            ...
            value: function (t, e, i, n) {
              ...
              if (
                ((a +=
                  t.vibratoGain *
                  Math.sin(2 * Math.PI * n * t.vibratoFrequency)),
                (a += 0.02 * this.noise.simplex1(4.07 * n)),
                (a += 0.04 * this.noise.simplex1(2.15 * n)),
                t.vibratoWobble > 0)
              ) {
                var o = 0;
                (o += 0.2 * this.noise.simplex1(0.98 * n)),
                  (a +=
                    (o += 0.4 * this.noise.simplex1(0.5 * n)) *
                    t.vibratoWobble);
              }
              var h = t.frequency;
              h *= 1 + a;
              var l = t.tenseness;
              (l += 0.1 * this.noise.simplex1(0.46 * n)),
                (l += 0.05 * this.noise.simplex1(0.36 * n)),
                (l += (3 - l) * (1 - r));
              var u = 1 / h,
                c = n - this.startSeconds,
                f = c / u;
              f >= 1 &&
                ((this.startSeconds = n + (c % u)),
                (f = this.startSeconds / u),
                this._updateCoefficients(l));
              var p = 0,
              ...
              (m *= d),
                (m *= r),
                (m *= r),
                (m *= 1 - Math.sqrt(Math.max(l, 0))),
                (m *= 0.02 * this.noise.simplex1(1.99 * n) + 0.2);
          ...
          { key: "update", value: function () {} },
          {
            ...
            value: function () {
              ...
              (i.a = e.a),
                (i.p = 1 / (2 * e.g)),
                (i.e = i.p + i.p * e.k),
                (this.coefficients.epsilon = 1 / i.a),
                (this.coefficients.shift = Math.exp(
                  -this.coefficients.epsilon * (1 - i.e)
                )),
              ...
              (n.RHS =
                ((1 / this.coefficients.epsilon) *
                  ...
                  (1 - i.e) * this.coefficients.shift) /
                this.coefficients.Delta),
                (n.total = {}),
                (n.total.lower = -(i.e - i.p) / 2 + n.RHS),
                (n.total.upper = -n.total.lower),
                (this.coefficients.omega = Math.PI / i.p);
              var r = Math.sin(this.coefficients.omega * i.e),
                s = (-Math.PI * r * n.total.upper) / (2 * i.p),
                a = Math.log(s);
              (this.coefficients.alpha = a / (i.p / 2 - i.e)),
                (this.coefficients.E0 =
                  -1 / (r * Math.exp(this.coefficients.alpha * i.e))),
                (this.coefficients.Te = i.e);
            },
          },
          {
        ...
        (i = [
          {
            ...
            value: function (t) {
              ...
              for (var e = 0; e < this.length; e++) {
                var i = e / this.length,
                  n = i < 0.5 ? 0.4 + 2 * i * 1.6 : 0.5 + 1.5 * (2 - 2 * i);
                this.diameter[e] = Math.min(n, 1.9);
              }
    ...
    (Math.interpolate = function (t, e, i) {
      return e * (1 - t) + i * t;
    }),
      (Math.clamp = function (t, e, i) {
        return t <= e ? e : t < i ? t : i;
          ...
          (this.tongue = {
            ...
            set index(t) {
              var e = 1 - this.range.diameter.interpolation(this.diameter),
                i = Math.pow(e, 0.58) - 0.2 * (Math.pow(e, 2) - e),
                n = this.range.index.centerOffset(i);
              this._index = Math.clamp(
                t,
                this.range.index.center - n,
                this.range.index.center + n
              );
            },
          }),
          (this.nose = new v(this)),
          (this.transients = []),
        ...
        (i = [
          ...
          },
          {
            ...
            value: function (t, e, i, n) {
              ...
              r != this.length && this._updateTractLength(r),
                ...
                this._processTransients(n),
                this._processConstrictions(this.previousConstrictions, t);
              var s = e / i,
                a = Math.random() < 0.1,
                o = 0;
              return (
                (o += this._processLips(t, s, a)),
                (o += this._processNose(t, s, a)),
                isNaN(o) && this.reset(),
                o
              );
            },
          },
          {
            ...
            value: function (t) {
              for (var e = this.transients.length - 1; e >= 0; e--) {
                ...
                (this.left[i.position] += i.amplitude),
                  i.update(t),
                  i.isAlive || this.transients.splice(e, 1);
              }
            },
          },
          {
              ...
              for (var i = 0; i < t.length; i++) {
                ...
                if (n.index >= 2 && n.index <= this.length && n.diameter > 0) {
                  ...
                  (r *= 0.66 * e.noiseModulator),
                    (r *=
                      (Math.clamp(8 * (0.7 - n.diameter), 0, 1) *
                        Math.clamp(30 * (n.diameter - 0.3), 0, 1)) /
                      2);
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              for (var n = 1; n < this.length; n++) {
                var r =
                  Math.interpolate(
                    e,
                    this.reflection[n],
                    this.reflection.new[n]
                  ) *
                  (this.right[n - 1] + this.left[n]);
                (this.right.junction[n] = this.right[n - 1] - r),
                  (this.left.junction[n] = this.left[n] + r);
              }
              ...
              this.left.junction[this.nose.start] =
                s * this.right[this.nose.start - 1] +
                (s + 1) * (this.nose.left[0] + this.left[this.nose.start]);
              ...
              this.right.junction[this.nose.start] =
                a * this.left[this.nose.start] +
                (a + 1) * (this.nose.left[0] + this.right[this.nose.start - 1]);
              ...
              for (var h = 0; h < this.length; h++)
                if (
                  ((this.right[h] = 0.999 * this.right.junction[h]),
                  (this.left[h] = 0.999 * this.left.junction[h + 1]),
                  i)
                ) {
                  var l = Math.abs(this.left[h] + this.right[h]);
                  this.amplitude.max[h] =
                    l > this.amplitude.max[h]
                      ? l
                      : 0.999 * this.amplitude.max[h];
                }
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              for (var n = 1; n < this.nose.length; n++) {
                var r =
                  this.nose.reflection[n] *
                  (this.nose.left[n] + this.nose.right[n - 1]);
                (this.nose.left.junction[n] = this.nose.left[n] + r),
                  (this.nose.right.junction[n] = this.nose.right[n - 1] - r);
              }
              for (var s = 0; s < this.nose.length; s++)
                if (
                  ((this.nose.left[s] =
                    this.nose.left.junction[s + 1] * this.nose.fade),
                  (this.nose.right[s] =
                    this.nose.right.junction[s] * this.nose.fade),
                  i)
                ) {
                  var a = Math.abs(this.nose.left[s] + this.nose.right[s]);
                  this.nose.amplitude.max[s] =
                    a > this.nose.amplitude.max[s]
                      ? a
                      : 0.999 * this.nose.amplitude.max[s];
                }
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (
                var i = Math.max(this.previousConstrictions.length, t.length),
                  n = 0,
                  r = t[0],
                  s = this.previousConstrictions[0];
                !e && n < i;
                r = t[++n], s = this.previousConstrictions[n]
              )
                e =
                  void 0 !== r && void 0 !== s
                    ? r.index !== s.index || r.diameter !== s.diameter
                    : !(null == r && null == s);
              if (e) {
                this._updateDiameterRest();
                for (var a = 0; a < this.length; a++)
                  this.diameter[a] = this.diameter.rest[a];
                this.velum.target = 0.01;
                for (var o = -1; o < t.length; o++) {
                  var h = t[o] || this.tongue;
                  if (
                    (h.index > this.nose.start &&
                      h.diameter < -this.nose.offset &&
                      (this.velum.target = 0.4),
                    h.index >= 2 &&
                      h.index < this.length &&
                      h.diameter > -(0.85 + this.nose.offset))
                  ) {
                    var l = h.diameter;
                    if (((l -= 0.3), (l = Math.max(0, l)) < 3)) {
                      var u = 2,
                        c = h.index / this.length;
                      ...
                      var f = this.indexRangeParams,
                        ...
                        g = f.upperIndexRange,
                        v = f.indexRange;
                      (u = c < p ? d : c >= m ? g : d - (g * (c - p)) / v),
                        (u *= this.length / 44);
                      for (
                        var y = Math.round(h.index), x = y - (Math.ceil(u) + 1);
                        x < y + u + 1 && x >= 0 && x < this.length;
                        x++
                      ) {
                        var b,
                          w = Math.abs(x - h.index) - 0.5;
                        b =
                          w <= 0
                            ? 0
                            : w > u
                            ? 1
                            : 0.5 * (1 - Math.cos((Math.PI * w) / u));
                        var M = this.diameter[x] - l;
                        M > 0 && (this.diameter[x] = l + M * b);
                      }
                    }
                  }
                }
              ...
              this.nose.amplitude[0] < 0.05 &&
                (this.transients.obstruction.last > -1 &&
                  ...
                  this.transients.push(
                    new x(this.transients.obstruction.new, t)
                  ),
        ...
        (i = [
          {
            ...
            value: function (t, e, i, n) {
              var r,
                s,
                a = 0,
                o = (r = this.glottis).process.apply(r, arguments);
              return (
                (t.glottis = o),
                (a += (s = this.tract).process.apply(s, arguments)),
                (e += 0.5),
                (a += this.tract.process(t, e, i, n)),
                (a *= 0.125)
              );
            },
          },
    ...
    function C(t) {
      ...
      return (C = function (t) {
        ...
        function n() {
          return A(t, arguments, T(this).constructor);
        }
        return (
    ...
    var I = (function (t) {
      function e() {
        ...
        return (
          ...
          ((t = V(this, T(e).call(this))).processor = new j()),
          (t.enabledConstrictionIndices = []),
          (t.port.onmessage = function (e) {
            switch (e.data.name) {
              case "enableConstriction":
                (t.enabledConstrictionIndices[e.data.constrictionIndex] = !0),
                  t.port.postMessage(e.data);
                break;
              case "disableConstriction":
                (t.enabledConstrictionIndices[e.data.constrictionIndex] = !1),
                  t.port.postMessage(e.data);
                break;
              case "enabledConstrictionIndices":
                (e.data.enabledConstrictionIndices =
                  t.enabledConstrictionIndices),
                  t.port.postMessage(e.data);
                break;
              case "getProcessor":
                (e.data.processor = JSON.stringify(t.processor)),
                  t.port.postMessage(e.data);
            }
          }),
          t
        ...
        (n = [
          {
            ...
            value: function (t, e) {
              for (
                var i = {}, n = 0;
                n < this.constructor.parameterDescriptors.length;
                n++
              ) {
                var r = this.constructor.parameterDescriptors[n];
                r.name.includes("constriction") ||
                  (i[r.name] =
                    1 == t[r.name].length ? t[r.name][0] : t[r.name][e]);
              }
              return i;
            },
          },
          {
            ...
            value: function (t) {
              for (var e = [], i = 0; i < a.numberOfConstrictions; i++)
            ...
            value: function (t, e, i) {
              for (var n = this._getConstrictions(i), r = 0; r < e.length; r++)
                for (var s = 0; s < e[r].length; s++)
                  for (var a = 0; a < e[r][s].length; a++) {
                    var o = this._getParameterSamples(i, a),
                      h = currentTime + a / sampleRate,
                      l = this.processor.process(o, a, e[r][s].length, h);
                    e[r][s][a] = l;
                  }
              return (
                this.processor.update(
                  currentTime + e[0][0].length / sampleRate,
                  n
                ),
                !0
              );
    ...
    })(C(AudioWorkletProcessor));
    registerProcessor("pink-trombone-worklet-processor", I);
  },
]);
