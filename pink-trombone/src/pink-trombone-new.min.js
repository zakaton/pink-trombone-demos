  ...
  function (t, e, n) {
        ...
        simplex2: {
          value: function (t, e) {
            ...
            var p = this.gradP[i + this.perm[o]],
              v = this.gradP[i + c + this.perm[o + h]],
              _ = this.gradP[i + 1 + this.perm[o + 1]],
              m = 0.5 - Math.pow(s, 2) - Math.pow(a, 2),
              g = m < 0 ? 0 : Math.pow(m, 4) * p.dot2(s, a),
              y = 0.5 - Math.pow(l, 2) - Math.pow(u, 2),
              b = y < 0 ? 0 : Math.pow(y, 4) * v.dot2(l, u),
              x = 0.5 - Math.pow(f, 2) - Math.pow(d, 2);
            return 70 * (g + b + (x < 0 ? 0 : Math.pow(x, 4) * _.dot2(f, d)));
          },
        },
        simplex1: {
          value: function (t) {
        ...
        (n = [
          {
            ...
            value: function (t, e, n, i) {
              ...
              (v *= p),
                (v *= o),
                (v *= o),
                (v *= 1 - Math.sqrt(Math.max(h, 0))),
                (v *= 0.02 * this.noise.simplex1(1.99 * i) + 0.2);
              var _ = this._getNormalizedWaveform(f);
              return (
                (_ *= o),
                (d = v + (_ *= r)),
                { outputSample: (d *= o), noise: v, voice: _ }
              );
            },
          },
            ...
            value: function () {
              ...
              (this.coefficients.alpha = s / (n.p / 2 - n.e)),
                (this.coefficients.E0 =
                  -1 / (o * Math.exp(this.coefficients.alpha * n.e))),
    ...
    var _ = function t(e) {
      !(function (t, e) {
        ...
        (this.length = Math.floor((28 * e.length) / 44)),
        (this.start = e.length - this.length + 1),
        (this.fade = 1),
        (this.offset = 0.8),
      ...
      for (var n = 0; n < this.length; n++) {
        var i = n / this.length,
          o = i < 0.5 ? 0.4 + 2 * i * 1.6 : 0.5 + 1.5 * (2 - 2 * i);
    ...
    var x = (function () {
      function t() {
        ...
        for (var n = 0; n < this.length; n++) {
          var i = 0;
          (i =
            n < (7 * this.length) / 44 - 0.5
              ? 0.6
              : n < (12 * this.length) / 44
              ? 1.1
              : 1.5),
            (this.diameter[n] = i),
            (this.diameter.rest[n] = i);
        }
        ...
        (n = [
          {
            ...
            value: function (t, e, n, i) {
              ...
              var o = e / n,
                r = Math.random() < 0.1,
                s = 0,
                a = this._processLips(t, o, r),
                c = this._processNose(t, o, r);
              return (
                (s += c + a),
                isNaN(s) && this.reset(),
                { outputSample: s, nose: c, lips: a }
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t, e, n) {
              ...
              for (var i = 1; i < this.length; i++) {
                ...
                (this.right.junction[i] = this.right[i - 1] - o),
                  (this.left.junction[i] = this.left[i] + o);
              }
              var r = Math.interpolate(
                e,
                this.left.reflection.new,
                this.left.reflection.value
              );
              this.left.junction[this.nose.start] =
                r * this.right[this.nose.start - 1] +
                (r + 1) * (this.nose.left[0] + this.left[this.nose.start]);
          ...
          },
          {
            ...
            value: function (t, e, n) {
              ...
              for (var i = 1; i < this.nose.length; i++) {
                ...
                (this.nose.left.junction[i] = this.nose.left[i] + o),
                  (this.nose.right.junction[i] = this.nose.right[i - 1] - o);
              }
              for (var r = 0; r < this.nose.length; r++)
                if (
                  ((this.nose.left[r] =
                    this.nose.left.junction[r + 1] * this.nose.fade),
                  (this.nose.right[r] =
                    this.nose.right.junction[r] * this.nose.fade),
                  n)
                ) {
                  var s = Math.abs(this.nose.left[r] + this.nose.right[r]);
                  this.nose.amplitude.max[r] =
                    s > this.nose.amplitude.max[r]
                      ? s
                      : 0.999 * this.nose.amplitude.max[r];
                }
            ...
            value: function (t) {
              ...
              for (
                var n = Math.max(this.previousConstrictions.length, t.length),
                  i = 0,
                  o = t[0],
                  r = this.previousConstrictions[0];
                !e && i < n;
                o = t[++i], r = this.previousConstrictions[i]
              )
                e =
                  void 0 !== o && void 0 !== r
                    ? o.index !== r.index || o.diameter !== r.diameter
                    : !(null == o && null == r);
              if (e) {
                  ...
                  if (
                    ...
                    if (((h -= 0.3), (h = Math.max(0, h)) < 3)) {
                      ...
                      l =
                        c.index < 25
                          ? 10
                          : c.index >= this.tip.start
                          ? 5
                          : 10 - (5 * (c.index - 25)) / (this.tip.start - 25);
                      for (
                        var u = Math.round(c.index), f = u - (Math.ceil(l) + 1);
                        f < u + l + 1 && f >= 0 && f < this.length;
                        f++
                      ) {
                        var d,
                          p = Math.abs(f - c.index) - 0.5;
                        d =
                          p <= 0
                            ? 0
                            : p > l
                            ? 1
                            : 0.5 * (1 - Math.cos((Math.PI * p) / l));
                        var v = this.diameter[f] - h;
                        v > 0 && (this.diameter[f] = h + v * d);
                      }
                    }
                  }
                }
              ...
              this.nose.amplitude[0] < 0.05 &&
                (this.transients.obstruction.last > -1 &&
                  ...
                  this.transients.push(
                    new g(this.transients.obstruction.new, t)
                  ),
        ...
        (n = [
          {
            ...
            value: function (t, e, n, i) {
              var o,
                ...
                l = a.voice;
              t.glottis = c;
              var u = (r = this.tract).process.apply(r, arguments),
                f = u.outputSample,
                d = u.nose,
                p = u.lips;
              (s += f), (e += 0.5);
              var v = this.tract.process(t, e, n, i),
                _ = v.outputSample,
                m = v.nose,
                g = v.lips;
              s += _;
    ...
    function j(t, e, n) {
      if (n.includes("constriction")) {
        ...
        (o[n.includes("index") ? "index" : "diameter"] = e),
          (t.constrictions[i] = o);
      } else
        n.includes("vibrato")
    ...
    if (
      ...
      var O = (function (t) {
        function e(t) {
          ...
          return (
            (i = this),
            (o = V(e).call(this, t, "pink-trombone-worklet-processor", {
              outputChannelCount: [6],
              channelCount: 6,
              channelInterpretation: "discrete",
            })),
            (n =
              !o || ("object" !== C(o) && "function" != typeof o) ? T(i) : o),
            S(T(n)),
            (n.channelSplitter = t.createChannelSplitter(6)),
            n.parameters.forEach(function (t, e) {
              j(T(n), t, e);
            }),
            n.connect(n.channelSplitter),
                ...
                return (
                  ...
                  new Promise(function (n, i) {
                    e.port.addEventListener("message", function i(o) {
                      t.id == Number(o.data.id) &&
                        (e.port.removeEventListener("message", i), n(o));
                    }),
      ...
      window.AudioContext.prototype.createPinkTromboneNode = function () {
        return A(O, [this].concat(Array.prototype.slice.call(arguments)));
      };
    } else
      window.AudioContext.prototype.createPinkTromboneNode = function () {
        var t = this,
        ...
        return (
          ...
          s.forEach(function (n, i) {
            ...
            o.start();
            var r = o.offset;
            (r.automationRate = n.automationRate || "a-rate"),
              (r.value = n.defaultValue || 0),
              o.connect(e.channelMerger, 0, i),
            ...
            value: function (t) {
              return void 0 !== t.audioWorklet
                ? t.audioWorklet.addModule(
                    "/pink-trombone/src/pink-trombone-worklet-processor-new.min.js"
                  )
        ...
        (n = [
          ...
          },
          {
            ...
            value: function () {
              if (!this._isDrawing) {
                ...
                for (var o = 1; o < this._processor.tract.nose.length; o++)
                  this._lineTo(
                    o + this._processor.tract.nose.start,
                    -this._processor.tract.nose.offset -
                      0.9 * this._processor.tract.nose.diameter[o]
                  );
                for (var r = this._processor.tract.nose.length - 1; r >= 1; r--)
                  this._lineTo(
          ...
          },
          {
            ...
            value: function (t, e, n) {
              ...
              this._context.save(),
                this._context.translate(this._getX(o, r), this._getY(o, r) + 2),
            ...
            value: function (t) {
              ...
              if (this._isActive) {
                var n = {
                  ...
                  o = 1 - Math.cos((1 - n.vertical) * Math.PI * 0.5),
                  r = {
                    frequency: i,
                    tenseness: o,
                    loudness: Math.pow(o, 0.25),
                  };
                Object.keys(r).forEach(function (t) {
                  e._container.dispatchEvent(
                    new CustomEvent("setParameter", {
                      bubbles: !0,
                      detail: { parameterName: t, newValue: r[t] },
                    })
                  );
                });
              }
    ...
    var z = (function () {
      function t() {
        ...
        !(function (t, e) {
          ...
          (this._tractUI = new U()),
          (this._glottisUI = new q()),
          (this._buttonsUI = new G()),
          (this._container = document.createElement("div")),
    ...
    function J(t) {
      ...
      return (J = function (t) {
        ...
        function i() {
          return K(t, arguments, $(this).constructor);
        }
        return (
          (i.prototype = Object.create(t.prototype, {
            constructor: {
    ...
    var tt = (function (t) {
      function e() {
        ...
        !(function (t, e) {
          ...
          ((t = Y(this, $(e).call(this)))._animationFrameObservers = []),
          window.customElements.whenDefined("pink-trombone").then(function () {
            t.addEventListener("requestAnimationFrame", function (e) {
              ...
              t.addEventListener("removeConstriction", function (e) {
                ...
                var o = e.detail;
                e.target.dispatchEvent(
                  new CustomEvent("didRemoveConstriction", { detail: o })
                ),
                  e.stopPropagation();
              }),
        ...
        (i = [
          {
            ...
            value: function () {
              null == this.UI &&
                ((this.UI = new z()), this.appendChild(this.UI.node)),
                this.UI.show();
            },
          },
          {
    ...
    document.createElement("pink-trombone").constructor == HTMLElement &&
      window.customElements.define("pink-trombone", tt);
    e.default = tt;
  },
]);
